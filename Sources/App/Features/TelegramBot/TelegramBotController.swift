...
final class TelegramBotController {
    ...
    private func sendWelcomeMessage(chatId: Int, req: Request) async {
        ...
        Я помогу создавать профессиональные статьи о путешествиях для Яндекс Дзен.
        
        📱 **Канал публикации:** \(AppConfig.telegramChannelId)
        ⚡ **Автопосты:** 2 раза в день
           🌅 08:00 MSK - утренний пост
           🌆 20:00 MSK - вечерний пост
        
        **Что умею:**
        • Генерация экспертного контента с AI
        • Короткие посты для Telegram (550-600 символов)
        • Полные статьи для Telegraph (3000-4000 символов)
        • Автоматическая публикация по расписанию
        • Создание изображений через Stability AI
        
        **Примеры тем:**
        • Бюджет путешествия в [страна]
        • Сравнение направлений
        • Практические гайды
        • Лайфхаки для путешественников
        
        Нажмите кнопку ниже чтобы создать пост 👇
        """
